...
})(exports.EventErrorId || (exports.EventErrorId = {}));
    ...
    onCompleted(cb) {
        ...
        this.onChunk(chunk => {
            ...
            if (chunk.citation?.endCitation) {
                ...
                if (offset === undefined) {
                    citationErrors.push({
                        citationId,
                        errorType: exports.CitationErrorType.CitationNotStarted
                    });
                }
                else {
                    citations.push({
        ...
        this.onContentPartEnd(endContentPart => {
            citationErrors.push(...Array.from(citationOffsets.keys())
                .map(citationId => ({ citationId, errorType: exports.CitationErrorType.CitationNotEnded })));
...
class MessageEventHelper extends ConversationEventHelperBase {
     ...
     */
    get isUser() {
        return this.startEventMaybe?.role === exports.MessageRole.User;
    }
    /**
     ...
     */
    get isAssistant() {
        return this.startEventMaybe?.role === exports.MessageRole.Assistant;
    }
    /**
     * Whether this message is a system message.
     */
    get isSystem() {
        return this.startEventMaybe?.role === exports.MessageRole.System;
    }
    /**
 ...
 */
const LOG_LEVELS = [exports.LogLevel.Debug, exports.LogLevel.Info, exports.LogLevel.Warn, exports.LogLevel.Error];
/**
...
class WebSocketLogger {
    constructor(prefix, level = exports.LogLevel.Info) {
        this._prefix = prefix;
        this._level = level;
    }
    /**
...
class BaseWebSocket {
    ...
    connectWithOptions(options) {
        ...
        const socket = socket_ioClient.io(host, {
            path,
            auth,
            query: options.query || {},
...
exports.AsyncToolCallEventHelper = AsyncToolCallEventHelper;
exports.AsyncToolCallEventHelperImpl = AsyncToolCallEventHelperImpl;
exports.ContentPartEventHelper = ContentPartEventHelper;
exports.ContentPartEventHelperImpl = ContentPartEventHelperImpl;
exports.ContentPartHelper = ContentPartHelper;
exports.ConversationEventHelperBase = ConversationEventHelperBase;
exports.ConversationEventHelperManager = ConversationEventHelperManager;
...
exports.ExchangeEventHelper = ExchangeEventHelper;
exports.ExchangeEventHelperImpl = ExchangeEventHelperImpl;
exports.ExchangeMap = ExchangeMap;
exports.ExchangeService = ExchangeService;
exports.Exchanges = ExchangeService;
exports.MessageEventHelper = MessageEventHelper;
exports.MessageEventHelperImpl = MessageEventHelperImpl;
exports.MessageMap = MessageMap;
exports.MessageService = MessageService;
exports.Messages = MessageService;
exports.SessionEventHelper = SessionEventHelper;
...
exports.assertInlineValue = assertInlineValue;
exports.createAgentWithMethods = createAgentWithMethods;
exports.createConversationWithMethods = createConversationWithMethods;
exports.isCitationSourceMedia = isCitationSourceMedia;
exports.isCitationSourceUrl = isCitationSourceUrl;
exports.isExternalValue = isExternalValue;
exports.isInlineValue = isInlineValue;
exports.transformExchange = transformExchange;
exports.transformExchanges = transformExchanges;
